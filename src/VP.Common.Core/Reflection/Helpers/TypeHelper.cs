...
namespace VP.Common.Core.Reflection
{
    public static class TypeHelper
    {
        ...
        {
            generic.ThrowIfNull(nameof(generic));
            toCheck.ThrowIfNull(nameof(toCheck));
        ...
        {
            fullyQualifiedAssemblyName.ThrowIfNullOrEmpty(nameof(fullyQualifiedAssemblyName));
        ...
        {
            fullTypeName.ThrowIfNullOrEmpty(nameof(fullTypeName));
        ...
        {
            assembly.ThrowIfNullOrEmpty(nameof(assembly));
